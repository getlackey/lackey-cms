...
exports.moduleInterface = function (modulePath, moduleName) {
    ...
    let api = {
         ...
         * @return {mixed}
         */
        model: (name, dontPromisify) => {
            return api.path('/server/models/' + name, dontPromisify);
        },
        /**
         * Loads module policy
         * @param {string} name
         * @return {mixed}
         */
        policy: (name, dontPromisify) => {
            return api.path('/server/policies/' + name, dontPromisify);
        },
        /**
         ...
         * @return {mixed}
         */
        controller: (name, dontPromisify) => {
            return api.path('/server/controllers/' + name, dontPromisify);
        },
        /**
         * Loads any path in modile
         */
        path: (filePath, dontPromisify) => {
            try {
