...
class DataSourcesManager {
    ...
    get(provider, connectionName) {
        ...
        if (!promise) {
            ...
            self._schemaManagers[provider] = self._schemaManagers[provider] || {};
    ...
    getManager(provider, connectionName) {
        return this.get(provider, connectionName)
            .then(() => this._schemaManagers[provider][connectionName]);
    }
    ...
    set(provider, connectionName, connection, disconnect) {
        ...
        this._schemaManagers[provider][connectionName] = new Manager(connection);
        if (disconnect) {
