...
/*    let testFriendlyPath = SUtils.getProjectPath() || __dirname + '/../../../mockup/project',
        upload = multer({
            dest: testFriendlyPath + '/uploads/tmp',
        });
    app.decorateMiddleware([], 'multer');*/
