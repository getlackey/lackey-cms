...
describe('Lackey CMS modules/cms Client Site - api.js', () => {
    ...
    it('READ /echo', () => {
        ...
        return api.read('/echo').then(() => {
            path.should.be.eql('/api/echo');
    ...
    it('CREATE /echo', () => {
        ...
        return api.create('/echo', data).then(() => {
            path.should.be.eql('/api/echo');
    ...
    it('UPDATE /echo', () => {
        ...
        return api.update('/echo/123', data).then(() => {
            path.should.be.eql('/api/echo/123');
