 ...
 * @class
 */
class UserPickerUI extends Emitter {

    /**
     * @constructs lackey-cms/modules/cms/client/manager/UserPickerUI
    ...
    buildUI() {
        let self = this;
        return template
            .render('cms/cms/user-picker', this.options || {})
            .then((nodes) => {
                self.node = nodes[0];
